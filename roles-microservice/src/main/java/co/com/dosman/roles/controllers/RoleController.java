...
public class RoleController {
    ...
    public ResponseEntity<MessageDTO> deleteRole(@PathVariable Long id) throws RoleException {
    ...
    public ResponseEntity<GetRoleDTO> getRoleById(@PathVariable Long id) throws RoleException {
    ...
    public ResponseEntity<GetRoleDTO> saveRole(@Valid @RequestBody CreateRoleDTO createRoleDTO) throws RoleException {
    ...
    public ResponseEntity<GetRoleDTO> updateRole(@Valid @RequestBody UpdateRoleDTO updateRoleDTO) throws RoleException {
